...
HXLINE(3359)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateCreate",bd,00,5a,98),::cpp::VirtualArray_obj::__new(1)->init(0,::CustomSubstate_obj::name),null(),null());
HXLINE(3360)		this->super::create();
HXLINE(3361)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateCreatePost",bd,53,4b,d5),::cpp::VirtualArray_obj::__new(1)->init(0,::CustomSubstate_obj::name),null(),null());
            	}


void CustomSubstate_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_8557063211c1ebb8_3372_update)
HXLINE(3373)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateUpdate",ca,1f,50,a3),::cpp::VirtualArray_obj::__new(2)->init(0,::CustomSubstate_obj::name)->init(1,elapsed),null(),null());
HXLINE(3374)		this->super::update(elapsed);
HXLINE(3375)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateUpdatePost",4a,7d,72,7b),::cpp::VirtualArray_obj::__new(2)->init(0,::CustomSubstate_obj::name)->init(1,elapsed),null(),null());
            	}


void CustomSubstate_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_8557063211c1ebb8_3379_destroy)
HXLINE(3380)		::PlayState_obj::instance->callOnLuas(HX_("onCustomSubstateDestroy",19,1c,82,c9),::cpp::VirtualArray_obj::__new(1)->init(0,::CustomSubstate_obj::name),null(),null());
