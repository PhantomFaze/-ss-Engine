...
HXLINE(  78)		bg1->scrollFactor->set(0,yScroll);
...
HXLINE(  91)		this->magenta->scrollFactor->set(0,yScroll);
...
HXDLIN(  94)			 ::flixel::util::FlxAxes axes1 = ::flixel::util::FlxAxes_obj::XY_dyn();
HXDLIN(  94)			bool _hx_tmp6;
HXDLIN(  94)			switch((int)(axes1->_hx_getIndex())){
            				case (int)0: case (int)2: {
...
HXLINE( 121)				{
HXLINE( 121)					 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::X_dyn();
...
HXLINE( 138)		versionShit2->scrollFactor->set(null(),null());
...
HXLINE( 271)			 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::X_dyn();
HXDLIN( 271)			if (::hx::IsNull( axes )) {
HXLINE( 271)				axes = ::flixel::util::FlxAxes_obj::XY_dyn();
            			}
HXDLIN( 271)			bool _hx_tmp;
HXDLIN( 271)			switch((int)(axes->_hx_getIndex())){
            				case (int)0: case (int)2: {
...
HXDLIN( 174)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 175)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.8))) {
HXLINE( 177)			 ::flixel::_hx_system::FlxSound fh = ::flixel::FlxG_obj::sound->music;
HXDLIN( 177)			fh->set_volume((fh->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
HXLINE( 178)			if (::hx::IsNotNull( ::FreeplayState_obj::vocals )) {
HXLINE( 178)				 ::flixel::_hx_system::FlxSound fh = ::FreeplayState_obj::vocals;
HXDLIN( 178)				fh->set_volume((fh->_volume + (((Float)0.5) * elapsed)));
            			}
            		}
...
HXDLIN( 276)		 ::MainMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
